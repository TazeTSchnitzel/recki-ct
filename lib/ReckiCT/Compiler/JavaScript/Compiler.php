...
namespace ReckiCT\Compiler\JavaScript;
        ...
        switch ($instruction[0]) {
            ...
            case 'label':
                if (!isset($ctx->labels[$instruction[1]])) {
                    $ctx->labels[$instruction[1]] = (count($ctx->labels) + 1);
                }
                $ctx->function .= 'case ' . $ctx->labels[$instruction[1]] . ":\n";
            ...
            case 'jump':
                ...
                $ctx->function .= 'label = ' . $ctx->labels[$instruction[1]] . "; continue;\n";
            ...
            case 'jumpz':
                ...
                if (!isset($ctx->labels[$instruction[2]])) {
                    $ctx->labels[$instruction[2]] = (count($ctx->labels) + 1);
                }
                $ctx->function .= "if (!" . $var . ') { label = ' . $ctx->labels[$instruction[2]] . "; continue; }\n";
